...
import { AddMaterial } from '../Features/Teachers/StudyMaterial/AddMaterial';
import { QuizList } from '../Features/Student/Quiz/QuizList';
    ...
    <Routes>
      <Route element={<PersistLogin />}>
        ...
        <Route element={<RequireAuth allowedRoles={ROLES_LIST.Teacher} />}>
          ...
          />
          <Route
    path='teacher/:classId/study-material'
    element={<AddMaterial />}
  />
        </Route>
...
<Route path='student/:classId/quizzes' element={<QuizList />} />
        </Route>
      </Route>
    </Routes>
  );
